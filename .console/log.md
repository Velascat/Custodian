...
**Migration work in progress (2026-05-01):**
- VF: creating _custodian/detectors.py plugin wrapping architecture invariants (capability_rules, singleton_rules, workflow_context_rules)
- VF: migrating import layer rules to S1 declarative YAML in .custodian.yaml
- OC: retiring OC1 (superseded by U1-U3) and OC7 (superseded by F3)
