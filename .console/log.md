...
| Ruff adapter: --no-cache flag; D7 return-None stub fix; 709 tests | RUFF_NO_CACHE=1 was invalid for newer ruff (exit code 2, silent 0 findings); switched to --no-cache flag. D7 _is_stub_body() now recognizes `return None` and bare `return` as null-object stubs (was flagging NullEmitter implementations). VF ruff findings exposed: 284 total (254 auto-fixed, 29 manual). VF Custodian: 0 findings. 2 new D7 tests. | 2026-05-03 |
